...
void MPAudioControlWM8731::resetInternalReg(void) {
	// Set to reset state
	regArray[0] = 0x97;
	regArray[1] = 0x97;
	regArray[2] = 0x79;
...
MPAudioControlWM8731::MPAudioControlWM8731()
{
	resetInternalReg();
}
...
void MPAudioControlWM8731::disable(void)
{
...
void MPAudioControlWM8731::enable(void)
{
  ...
  regArray[WM8731_REG_INTERFACE] = 0xE;
  write(WM8731_REG_INTERFACE, regArray[WM8731_REG_INTERFACE]); // I2S, 16 bit, MCLK slave

  regArray[WM8731_REG_SAMPLING] = 0x00; // 00 1000 00
  write(WM8731_REG_SAMPLING, regArray[WM8731_REG_SAMPLING]);  // 256*Fs, 44.1 kHz, MCLK/1
...
void MPAudioControlWM8731::setLeftInputGain(int val)
{
...
void MPAudioControlWM8731::setLeftInMute(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setLinkLeftRightIn(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setRightInputGain(int val)
{
...
void MPAudioControlWM8731::setRightInMute(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setLeftRightSwap(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setHeadphoneVolume(float volume)
{
...
void MPAudioControlWM8731::setDacMute(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setDacSelect(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setAdcBypass(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setHPFDisable(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::setActivate(bool val)
{
	if (val) {
...
void MPAudioControlWM8731::resetCodec(void)
{
	write(WM8731_REG_RESET, 0x0);
	resetInternalReg();
}

void MPAudioControlWM8731::recalibrateDcOffset(void)
{
    // mute the inputs
    setLeftInMute(true);
    setRightInMute(true);
...
bool MPAudioControlWM8731::writeI2C(unsigned int addr, unsigned int val)
{
	return write(addr, val);
}

// Low level write control for the codec via the Teensy I2C interface
bool MPAudioControlWM8731::write(unsigned int reg, unsigned int val)
{
	bool done = false;
...
void MPAudioControlWM8731::setOutputStrength(void)
{
